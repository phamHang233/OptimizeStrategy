...
from src.services.calculate_from_strategy import tokens_for_strategy, liquidity_for_strategy, calc_fees, pivot_fee_data
from src.crawlers.uni_pool_data import pool_by_id, get_pool_hour_data
from src.utils.sqrt_price_math import get_token_amount_of_user, convert_price_to_tick
...
# start_timestamp = int(end_timestamp / 24 /3600) * 24 * 3600 - 30 * 24 * 3600 -1
# res, time = uniswap_strategy_backtest(pool="0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640", investment_amount=96537.09169466,
#                                        min_range=1 / 1.0001 ** 196920 * 10 ** 12,
#                                        max_range=1 / 1.0001 ** 193260 * 10 ** 12,
